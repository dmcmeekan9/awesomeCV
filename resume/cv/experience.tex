...
%        \item {Dedicated time to the children to help them understand how to work with other peers and teach teamwork and %            work ethic.}
%      \end{cvitems}
%    }
%---------------------------------------------------------
%    \cventry
...
%        \item {Worked while also being a full-time student and playing sports.}
%      \end{cvitems}
%    }
%---------------------------------------------------------
\end{cventries}
